-- ============================================================
-- Fix: fn_financeiro_criar_pagamento_pix usava gen_random_bytes()
-- da extensao pgcrypto. A funcao roda com search_path=public, mas
-- pgcrypto fica no schema extensions; resultado:
--   function gen_random_bytes(integer) does not exist
--
-- Solucao: trocar pela combinacao md5 + clock_timestamp, que produz
-- 32 chars hex sem precisar de pgcrypto. Mantemos digest() (sha256)
-- via mudanca para a funcao md5 builtin do Postgres, que basta para
-- o hash do payload Pix em ambiente de sandbox/dev.
-- ============================================================
...
begin
  ...
  -- FIX: usa md5 builtin no lugar de gen_random_bytes (pgcrypto)
  ...
  -- FIX: md5 builtin no lugar de digest(...,'sha256')
  v_hash := md5(v_pix);
