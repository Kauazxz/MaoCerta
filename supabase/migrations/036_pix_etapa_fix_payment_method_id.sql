-- ============================================================
-- Fix: a funcao fn_financeiro_criar_pagamento_pix tentava inserir
-- na coluna "pagamento_method_id", mas o schema real da tabela
-- public.pagamentos define essa coluna como "payment_method_id"
-- (inglês). Erro:
--   column "pagamento_method_id" of relation "pagamentos" does
--   not exist
--
-- Esse typo (mistura PT/EN) estava nas migrations 021, 031 e 035.
-- Aqui recriamos a funcao com o nome correto da coluna.
-- ============================================================
...
begin
  ...
  insert into public.pagamentos (
    ...
    payment_method_id, client_ip, user_agent, device_fingerprint,
